...
export default function page() {
    ...
    <div className={`${arkidenz.className}`}>
        <div className='flex bg-grey-200 rounded-[1.5rem]'>
            <div className='w-[45%] bg-grey-200 rounded-[1.5rem] text-center flex justify-center gap-8 flex-col text-body px-[5rem] py-[2rem]'>
        ...
        <h2 className={`h4-bold text-grey-200 mt-[3rem] mb-[2rem]`}>{dict.aboutUs.infrastructureTitle}</h2>
        {
            dict.aboutUs.infrastructure.map((r, index) => { return <div className='text-center text-body text-grey-200 flex' key={index}>{greenMark}{r}</div>})
        }
        ...
        <ol className='list-decimal'>
            {
                dict.aboutUs.rules.map((r, index) => <li className='text-body text-grey-200' key={index}>{r}</li>)
            }
        </ol>
        <h2 className={`h4-bold text-grey-200 mt-[3rem] mb-[2rem]`}>{dict.aboutUs.forbiddenTitle}</h2>
        <ol className='list-decimal'>
            {
                dict.aboutUs.forbidden.map((r, index) => <li className='text-body text-grey-200' key={index}>{r}</li>)
            }
        </ol>
        <p className='text-body text-grey-200 uppercase mt-4'>{dict.aboutUs.warning}</p>
    </div>
    )
}
