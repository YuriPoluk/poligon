    ...
    <>
      ...
      <div className='flex flex-row justify-around mt-[1.5rem]'>
        <div className='flex flex-col gap-[1rem] mr-6'>
          <h2 className={`${arkidenz.className} text-white text-[2rem] font-bold uppercase`}>{dict.contacts.title}</h2>
          <div className='flex align-center'>
            <Image src={phoneIcon} alt="icon phone" className='inline-block mr-[0.5rem]'></Image>
            <span className={`text-normal text-white text-[1.3125rem] ${arkidenz.className} leading-[133%]`}>{dict.contacts.phone}</span>
          </div>
          <div className='flex align-center'>
            <Image src={markerIcon} alt="icon marker" className='inline-block mr-[0.5rem]'></Image>
            <span className={`text-normal text-white text-[1.3125rem] ${arkidenz.className} leading-[133%]`}>{dict.contacts.address}</span>
          </div>
          <div className='flex align-center'>
            <Image src={calendarIcon} alt="icon calendar" className='inline-block mr-[0.5rem]'></Image>
            <span className={`text-normal text-white text-[1.3125rem] ${arkidenz.className} leading-[133%]`}>{dict.contacts.openHours}</span>
          </div>
        </div>
        <div className='flex flex-col gap-[1rem]'>
          <h2 className={`${arkidenz.className} text-white text-[2rem] font-bold uppercase`}>{dict.contacts.socials}</h2>
